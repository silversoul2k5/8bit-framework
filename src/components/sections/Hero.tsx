...
import { ArrowUpRight, Cpu, Github, Instagram, Linkedin } from "lucide-react";
          ...
          <div className="relative z-10">
            ...
            <div className="relative mt-4 grid min-h-[520px] items-end gap-8 md:min-h-[610px] lg:-mt-10 lg:grid-cols-[0.54fr_0.8fr_0.38fr] lg:gap-7">
              ...
              >
                ...
                <h1 className="mt-4 text-4xl font-extrabold leading-tight tracking-[-0.03em] md:text-[3.5rem] lg:text-[3.75rem]">
